                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
							...
							<?php
								...
								$qry="SELECT `topic`,`incep_date`, `status` FROM `submissions` WHERE `user_id`=$name_id";
								...
								while ($data= mysqli_fetch_assoc($run))
									...
									<tr>
									<td><?php echo $row;?> </td>
									<td><?php echo $data['incep_date'];?> </td>
									<td><?php echo $data['topic'];?> </td>
									
									<td class="badge badge-success"><?php echo $sts;?> </td>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="user_submission.php?id=<?php echo $name_id?>" class="nav-link active"><i class="fa fa-list"></i>Submit Research Paper</a></li>
