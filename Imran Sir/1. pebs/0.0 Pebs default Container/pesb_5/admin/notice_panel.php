                                        ...
                                        <form action="insert_notice.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Notice:</label>
                                                </div>												
														
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="notice" placeholder="Notice" class="form-control">
												...
												<div class="row form-group">
												   ...
												   <button name="submit_notice" type="submit" class="btn btn-primary btn-sm" >
