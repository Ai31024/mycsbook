			...
			<!-- volume name on table head -->
					 ...
					 <?php
						include('db_conn.php');
							...
							$qry="SELECT id, sl_no, header, author, pages, date_incep from headings WHERE `title_id`= $user_id";
												...
												?>			
															...
															<li><a class="btn btn-template-outlined btn-sm" href="abstract.php?id=<?php echo $data['id'];?>">Abstract</a></li>
															</ul>
															</td>															
															</tr>
