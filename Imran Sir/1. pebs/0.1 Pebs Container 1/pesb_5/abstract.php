...
<html>
 ...
 <div id="heading-breadcrumbs">
		...
		<!-- volume name on breadcrumb -->			 
					 
					 
					 <?php
						include('db_conn.php');
											
							$qry1="SELECT volume_name, publish_date from title WHERE `id`= $user_id";
								...
								$run1 = mysqli_query($con,$qry1);
									...
									while ($data1= mysqli_fetch_assoc($run1))
										...
										{
											?>			
												 <h1 class="h2"><?php echo $data1['volume_name'], "-", $data1['publish_date'] ;?> </h1>														
						...
						include('db_conn.php');
								...
								$run2 = mysqli_query($con,$qry1);
									...
									while ($data2= mysqli_fetch_assoc($run2))
										...
										{
											?>			
												 <td><h1 class="h2"><?php echo $data2['volume_name'], "-", $data2['publish_date'] ;?> </h1></td>														
			...
			<!--  name on table head -->
					 ...
					 <?php
						include('db_conn.php');
							...
							$qry="SELECT id, sl_no, header, author, pages, date_incep, key_words, abstract_matter,document_path from headings WHERE `id`= $user_id";
												...
												?>			
															...
															<h4 class="h4"><li><?php echo $data['sl_no'], ". ", $data['header'];?></li> </h4>
															
															<li><?php echo "", "Author: ",$data['author'];?></li>
															<li><?php echo "Pages: ", $data['pages'];?></li> 
															<li><?php echo "Date of Inception: ", $data['date_incep'];?></li>
															<li><?php echo "Keywords: ", $data['key_words'];?></li>
															...
															<p><?php echo $data['abstract_matter'];?></p>
															<li><a class="btn btn-template-outlined btn-sm" href=<?php echo $data['document_path']?>>Download pdf</a></li>
															</ul>
															</td>															
															</tr>
