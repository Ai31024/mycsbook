            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item "><a href="aim.php"  >Aim & Scope</a>
				 ...
				 <li class="nav-item active "><a href="#" >Advisory & Editorial Board</a>
     ...
     <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Our Advisory & Editorial Board</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.php">Home /</a></li>
                <li color="#0066ff" > Advisory & Editorial Board</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <section class="bar">
            <div class="row">
              <div class="col-lg-12">
                <div class="heading">
				 ...
				 <?php
					include('db_conn.php');											
						$qry1="SELECT * FROM `eiditor` WHERE `post_name`='Editor'";
									...
									$row = mysqli_num_rows($run1);																										
										while ($data1= mysqli_fetch_assoc($run1))
											...
											{
												echo "<p class=lead>".$data1['editor_name']."</p>";
											}
							mysqli_close($con);				
						?>
			...
			<div class="row">
              <div class="col-lg-12">
                <div class="heading">
                  <h2>Consulting Editor:</h2>
                </div>
				
				<?php
					include('db_conn.php');											
						$qry1="SELECT * FROM `eiditor` WHERE `post_name`='Consulting Editor'";
			...
			<div class="row">
              <div class="col-lg-12">
                <div class="heading">
                  <h2>Managing Editor (Business):</h2>
                </div>
                <?php
					include('db_conn.php');											
						$qry1="SELECT * FROM `eiditor` WHERE `post_name`='Managing Editor'";
                ...
                <div id="accordion" role="tablist">
                  <div class="card">
                    <div id="headingOne" role="tab" class="card-header">
                      <h4 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">EDITORIAL BOARD</a></h4>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <?php
								include('db_conn.php');											
									$qry1="SELECT * FROM `eiditor` WHERE `post_name`='Editorial Board'";
                  ...
                  <div class="card">
                    <div id="headingTwo" role="tab" class="card-header">
                      <h4 class="mb-0 mt-0"><a data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="collapsed">ADVISORY BOARD </a></h4>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <?php
								include('db_conn.php');											
									$qry1="SELECT * FROM `eiditor` WHERE `post_name`='Advisory Board'";
