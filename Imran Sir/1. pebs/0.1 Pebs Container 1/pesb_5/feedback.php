        ...
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown "><a href="index.php" >Home <b class="caret"></b></a>
      ...
      <section class="bar pt-0">
            <div class="row">
              ...
              <div class="col-md-8 mx-auto">
                <form action="mailer_feedback.php" method="post">
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="ph-input">Phone No.(Optional)</label>
                        <input id="mobile_input" name="mobile_input" type="text" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="message-input">Message/ Complain</label>
                        <textarea id="message_input" name="message_input" class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="col-sm-12 text-center">
                      <button type="submit" name="feedback" class="btn btn-template-outlined"><i class="fa fa-envelope-o"></i> Send message</button>
                    </div>
                  </div>
                </form>
              </div>
